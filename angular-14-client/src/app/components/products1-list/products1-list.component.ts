...
@Component({
  selector: 'app-products1-list',
  templateUrl: './products1-list.component.html',
  styleUrls: ['./products1-list.component.css']
})
export class Products1ListComponent implements OnInit {
